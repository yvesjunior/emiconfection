...
class SubCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($file = $request->file('fimage')){
            ...
            FileHelper::moveCacheToImages("categories", "assets/images/categories/".$photo_name, $photo_name);
    ...
    {
        $category = Category::findOrFail($id);
        FileHelper::removeImageFile("categories", "assets/images/categories/".$category->feature_image, $category->feature_image);
