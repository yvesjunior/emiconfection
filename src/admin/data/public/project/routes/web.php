...
Route::get('/api/categories', 'ApiController@getCategories');
Route::get('/api/category{id}', 'ApiController@getCategory');

Route::get('/api/products', 'ApiController@getProducts');
Route::get('/api/product{id}', 'ApiController@getProduct');
Route::post('/addproduct', 'ApiController@add');


Route::get('/failures', 'FrontEndController@failures')->name('request.failures');
Route::get('/', 'FrontEndController@index');
Route::get('/all-categories/{cat}', 'FrontEndController@allCategories');
Route::get('/sub-all-categories/{cat}/{id}', 'FrontEndController@subAllCategories');
Route::get('/sub-categories/{main}/{sub}', 'FrontEndController@subCategories');

Route::get('/categories/{id}', 'FrontEndController@getProductsFromCategory');

Route::get('/product-single/{id}', 'FrontEndController@singleProduct');
