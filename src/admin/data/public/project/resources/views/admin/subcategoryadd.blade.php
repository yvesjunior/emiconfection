            ...
            <div class="row" id="main">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        @endif
                        <div id="response"></div>
                        <form method="POST" action="{!! action('SubCategoryController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Categorie Principale<span class="required">*</span>

                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="mainid" required>
                                        <option value="">Selectionner Categorie Principale</option>
