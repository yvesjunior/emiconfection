                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="Groceries">{{$category->name}}</button>
                            </h2>
                                ...
                                <ul class="accordion-body">
                                    @foreach($subcategories as $subcat)
                                        @if($subcat->id == $subcategory->id)
                                            <li><a href="/sub-all-categories/{{$category->id}}/{{$subcat->id}}" class="active" >{{$subcat->name}}</a></li>
                                        @else
                                            <li><a href="/sub-all-categories/{{$category->id}}/{{$subcat->id}}">{{$subcat->name}}</a></li>
                                        @endif
                                    @endforeach
                                </ul>
                            </div>
                    ...
                    <div class="product-card">
                        ...
                        <div class="product__content">
                            ...
                            <div class="product__title">
                                <h5>
                                    <a href="product-single">{{$product->title}}<br> 
                ...
                <div class="flyout__menu">
                    <ul class="flyout-main__menu">
                        ...
                        <li class="has__dropdown">
                            ...
                            <ul class="sub__menu">
                                <li><a href="/all-categories/tissus/kentes">Kentes</a></li>
                                <li><a href="/all-categories/tissus/fasodanfani">Faso Danfani</a></li>
                                <li><a href="/all-categories/tissus/modernes">Modernes</a></li>                            
                            </ul>
                        </li>
                        <li class="has__dropdown">
                            <a href="/all-categories/coutures" class="nav__link active">Coutures</a>
                            <ul class="sub__menu">
                                <li><a href="/all-categories/coutures/femmes">Femmes</a></li>
                                <li><a href="/all-categories/coutures/hommes">Hommes</a></li>                           
                            </ul>
                        </li>
                        <li class="has__dropdown">
                            <a href="/all-categories/accessoires" class="nav__link active">Accessoires</a>
                            <ul class="sub__menu">
                                <li><a href="/all-categories/accessoires/meches">Mêches</a></li>
                                <li><a href="/all-categories/accessoires/perruques">Perruques</a></li>
                                <li><a href="/all-categories/accessoires/éventails">Éventails</a></li>                           
                            </ul>
                        </li>
                    </ul>
                </div>
