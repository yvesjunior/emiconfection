                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                <li class="active"><a href="#maincat" data-toggle="tab" aria-expanded="false"><strong> Categorie Principal</strong></a>
                                <li><a href="#subcat" data-toggle="tab" aria-expanded="true"><strong>Sous Categorie</strong></a>
                                <!-- <li><a href="#childcat" data-toggle="tab" aria-expanded="true"><strong> Categorie enfant</strong></a> -->
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-xs-12" style="padding: 0">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="maincat">
                                    <div class="go-title">
                                        <div class="pull-right">
                                            <a href="{!! url('admin/categories/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Ajouter Categorie Principal</a>
                                        </div>
                                        <h3>Categorie Principal</h3>
                                ...
                                <div class="tab-pane" id="subcat">
                                    <div class="go-title">
                                        <div class="pull-right">
                                            <a href="{!! url('admin/subcategory/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Ajouter Sous Category</a>
                                        </div>
                                        <h3>Sous Category</h3>
                                        <div class="go-line"></div>
                                    </div>
                                            ...
                                            <table class="table table-striped table-bordered" cellspacing="0" id="example2" width="100%">
                                                ...
                                                @foreach($subs as $sub)
                                                    <tr>
                                                        ...
                                                        <!-- <td>{{$sub->slug}}</td> -->
                                                        <td>
                                                            <a href="subcategory/{{$sub->id}}/edit" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Editer </a>
                                                            <a href="javascript:;" data-href="{{url('/')}}/admin/categories/delete/{{$sub->id}}" data-toggle="modal" data-target="#confirm-delete"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Supprimer</a><br>
                                ...
                                <!-- <div class="tab-pane" id="childcat">
                                    <div class="go-title">
                                        <div class="pull-right">
                                            <a href="{!! url('admin/childcategory/create') !!}" class="btn btn-primary btn-add"><i class="fa fa-plus"></i> Ajouter Categorie enfant</a>
                                        </div>
