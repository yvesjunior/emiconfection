                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="payment">
                                    ...
                                    <form method="POST" action="settings/payment" class="form-horizontal form-label-left" id="website_form">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title"> Fixed Commission(CAD) <span class="required">*</span>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title"> Withdraw Fee(CAD) <span class="required">*</span>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title"> Shipping Cost(CAD) <span class="required">*</span>
