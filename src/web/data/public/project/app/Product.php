...
{
    protected $fillable = ['title', 'category', 'subcategory', 'tags', 'description', 'price', 'stock', 'feature_image', 'images', 'featured', 'views', 'created_at', 'updated_at', 'status', 'discount_id', 'code'];
